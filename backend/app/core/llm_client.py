    ...
    async def generate_completion(
        ...
        with telemetry.start_span(
            ...
            if not self.check_and_consume_budget(user_id, estimated_tokens=estimated_tokens, tier=tier):
                span.set_attribute("llm.budget_exceeded", True)
                if fallback_fn:
            ...
            if self.provider == "openai" and settings.OPENAI_API_KEY:
                try:
                    ...
                    span.set_attribute("llm.engine", "openai")
            ...
            if self.provider == "anthropic" and settings.ANTHROPIC_API_KEY:
                try:
                    ...
                    span.set_attribute("llm.engine", "anthropic")
            ...
            span.set_attribute("llm.engine", "deterministic_fallback")
