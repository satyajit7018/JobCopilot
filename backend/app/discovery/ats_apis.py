...
class ATSApiFeeders:
    ...
    async def fetch_greenhouse_jobs(cls, company_slug: str, client: Optional[httpx.AsyncClient] = None) -> List[Dict[str, Any]]:
        ...
        """
        with telemetry.start_span("ats.fetch", attributes={"ats.platform": "Greenhouse", "ats.company": company_slug}) as span:
            ...
            try:
                ...
                span.set_attribute("ats.jobs_count", len(jobs))
            except CircuitOpenError as e:
                span.set_attribute("circuit.open", True)
    ...
    async def fetch_lever_jobs(cls, company_slug: str, client: Optional[httpx.AsyncClient] = None) -> List[Dict[str, Any]]:
        ...
        """
        with telemetry.start_span("ats.fetch", attributes={"ats.platform": "Lever", "ats.company": company_slug}) as span:
    ...
    async def fetch_ashby_jobs(cls, company_slug: str, client: Optional[httpx.AsyncClient] = None) -> List[Dict[str, Any]]:
        ...
        """
        with telemetry.start_span("ats.fetch", attributes={"ats.platform": "Ashby", "ats.company": company_slug}) as span:
