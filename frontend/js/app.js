...
// ==========================================================================
// Portal Connection State Machine & Onboarding — extracted to js/modules/portal-onboarding.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// PWA & Android Installation Management — extracted to js/modules/pwa-install.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================
...
// ==========================================================================
// Resume Drag-and-Drop Ingestion (Step 2) — extracted to js/modules/resume-ingestion.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================
...
// ==========================================================================
// Recruiter Call Logger + Held Applications/HITL — extracted to
// js/modules/pipeline-actions.js (bundled after app.js; see build.js SOURCES).
// ==========================================================================

// ==========================================================================
// Knowledge Vault Studio & Search — extracted to js/modules/knowledge-vault.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// Inbound Email Radar (Step 8 & 9) — extracted to js/modules/inbound-email.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// VIEW 5: AI Mock Interview Studio — extracted to js/modules/interview-studio.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// Reverse-Interview Questions & Interviewer Sleuth — extracted to js/modules/reverse-interview.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// Multi-Offer Comparison & Counter-Offer — extracted to js/modules/negotiation.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// Triple-Threat Outreach & Alumni Referral Engine — extracted to js/modules/outreach.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// Funnel Analytics & Backups — extracted to js/modules/funnel-analytics.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================

// ==========================================================================
// Command Palette (Cmd + K) — extracted to js/modules/command-palette.js
// (loaded as a separate classic script after app.js; see index.html).
// ==========================================================================
...
// ==========================================================================
// SaaS Multi-Tenancy, Enterprise Admin, Billing & GDPR — extracted to js/modules/saas-admin.js
// (bundled after app.js; see frontend/build.js SOURCES).
// ==========================================================================
